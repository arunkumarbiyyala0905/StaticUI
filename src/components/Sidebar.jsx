...
import newChatHistoryIcon from '../assets/newChatHistoryIcon.png'; // Download and place a new chat icon here
              ...
              <ListItem button>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', width: 288, background: '#C8102E', color: '#fff' }}>
                      <ListItemIcon sx={{ minWidth: 32, mr: 0 }}>
                          <img src={newChatHistoryIcon} alt="Chat History" style={{ width: 24, height: 24 }} />
                      </ListItemIcon>
